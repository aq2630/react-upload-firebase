    ...
    <div className="product">
      ...
      <Container>
        ...
        <Row>
          ...
          <Col className="pt-3" md="3">
            <Card style={{ width: '16rem' }}>
              <img alt="product" src={Product10} />
              <Card.Body />
            </Card>
          </Col>
          <Col className="pt-3" md="3">
            <Card style={{ width: '16rem' }}>
              <img alt="product" src={Product11} />
              <Card.Body>
      ...
      <Container>
        ...
        <Row>
          ...
          <Col className="pt-3" md="3">
            <Card style={{ width: '16rem' }}>
              <img alt="product" src={Product14} />
              <Card.Body />
            </Card>
          </Col>
          <Col className="pt-3" md="3">
            <Card style={{ width: '16rem' }}>
              <img alt="product" src={Product15} />
              <Card.Body />
            </Card>
          </Col>
          <Col className="pt-3" md="3">
